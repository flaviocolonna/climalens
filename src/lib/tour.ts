/**
 * Il percorso: otto passaggi che attraversano quello che l'app sa già fare.
 *
 ...
 * cosa succede → chi lo causa → cosa si respira → chi può reggerlo → da cosa
 * viene → dove porta → cosa puoi fare.
 *
 ...
 * indirizzabile per l'URL — il percorso è, letteralmente, otto link interni.
 */
